...
const BookSearch = () => {
    ...
    const getUserIdFromToken = () => {
        ...
        if (token) {
            ...
            return decoded.user_id; // Adjust according to your token structure
        }
        return null;
    };
        ...
        try {
            ...
            if (res.status === 201) {
                ...
                const bookListData = {
                    list_type: "to read",
                    book: bookId,
                    user: userId, // Use dynamic user ID
                    orgId: id
                };
        ...
        <div className="min-h-screen">
            <div className='m-12 overflow-x-hidden h-full'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <h2 className="flex flex-col items-center text-2xl font-bold mb-4 font-secondary text-gray-200">
                        Add them to your 
                        <h1 
                            onClick={() => navigate("/mybooks")} 
                            className="text-3xl font-primary mb-4 font-bold text-white bg-slate-800 p-2 rounded-md mt-2 hover:scale-105 hover:cursor-pointer"
                        >  
                            Library
                        </h1>
                    </h2>
                ...
                <div className='flex flex-wrap w-full justify-center'>
                    ...
                    {books.length > 0 ? (
                        books.map((book) => (
                            <div key={book.id} className="m-8 group">
                                ...
                                <div className="flex flex-col justify-center items-center max-w-40 h-full rounded overflow-hidden shadow-lg">
                                    ...
                                    <div className="px-6 py-4 flex items-center flex-col justify-center">
                                        <div className='relative group'>
                                            <div className="font-bold text-white mb-2 flex justify-center items-center">{book.title?.substring(0, 12)}..</div>
                                        </div>
                                    ...
                                    <div className="px-6 pt-4 pb-2">
                                        <div 
                                            ...
                                            className='bg-blue-200 p-2 text-gray-700 hover:scale-110 hover:cursor-pointer rounded-lg'
                                        >
                                            Add to library
                                        </div>
                                    </div>
                        ...
                        <p className='text-gray-300 mt-8 font-bold'>No books found.</p>
                    )}
                </div>
            </div>
        </div>
